        ...
        <div className="text-center">
          ...
          <MotionWrapper variant="fade-up" delay={0.2}>
            <p className="text-lg text-primary-100 max-w-xl mx-auto mb-8 leading-relaxed">
              Encontre lojas, servicos e profissionais perto de voce.
              Tudo em um so lugar, facil e rapido.
            </p>
          </MotionWrapper>
          ...
          <MotionWrapper variant="fade-up" delay={0.3}>
            ...
            >
              ...
              <span className="text-sm sm:text-base text-slate-400 flex-1 text-left">
                Buscar lojas, servicos, produtos...
              </span>
          ...
          <MotionWrapper variant="fade-up" delay={0.5}>
            <div className="mt-12 flex items-center justify-center gap-8 sm:gap-12">
              <div className="text-center">
                ...
                <p className="text-xs sm:text-sm text-primary-200 mt-0.5">Negocios</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-xs sm:text-sm text-primary-200 mt-0.5">Avaliacoes</p>
              </div>
              <div className="h-8 w-px bg-white/20" />
              <div className="text-center">
                <div className="text-2xl sm:text-3xl font-extrabold text-white">
