    ...
    <div className="flex min-h-screen bg-slate-50">
      ...
      <aside className="hidden lg:flex lg:w-64 lg:flex-col lg:fixed lg:inset-y-0 border-r border-slate-200 bg-white">
        ...
        <div className="p-3 border-t border-slate-100 space-y-1">
          <div className="px-3 py-2 text-xs text-slate-400 truncate">{userName}</div>
          <Link
            href="/"
          ...
          <form action={logout}>
            <button
              type="submit"
              className="flex w-full items-center gap-2 px-3 py-2.5 rounded-xl text-sm text-red-500 hover:bg-red-50 hover:text-red-700 transition-colors"
            >
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 z-30 bg-white border-b border-slate-200 h-14">
        <div className="flex items-center justify-between h-full px-4">
          ...
          <Link href="/" className="text-xs text-slate-500 font-medium">Site</Link>
        </div>
      </div>
