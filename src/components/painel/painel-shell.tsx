...
import { LayoutDashboard, Store, Package, Star, CreditCard, ArrowLeft, BarChart3, Users, Tag, LogOut } from 'lucide-react'
...
export function PainelShell({ children, userName, businessName }: PainelShellProps) {
