...
export default function FavoritosPage() {
    ...
    // Filter mocked businesses by the saved IDs
                ...
                <div className="relative max-w-5xl mx-auto text-center">
                    <MotionWrapper variant="fade-up">
                        ...
                        <p className="text-primary-100 max-w-lg mx-auto">
                            Sua lista VIP de lugares em Rio Bonito. Salve aqui os negócios que você mais gosta para achar rapidinho.
                        </p>
                    </MotionWrapper>
                </div>
            </div>
                ...
                {favoriteBusinesses.length > 0 ? (
                    ...
                    <MotionWrapper variant="scale">
                        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 sm:p-12 text-center max-w-md mx-auto">
                            ...
                            <Link
                                href="/buscar"
                                className="inline-flex items-center justify-center gap-2 rounded-xl bg-primary-600 px-6 py-3.5 text-sm font-bold text-white hover:bg-primary-700 transition-colors shadow-sm active:scale-95"
                            >
