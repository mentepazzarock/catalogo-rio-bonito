  ...
  return (
    <div className="min-h-screen bg-slate-50/50">
      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 -mt-16 relative z-10 pb-16">
        {/* Profile Header */}
        <div className="rounded-2xl bg-white border border-slate-200 shadow-sm p-6 sm:p-8 mb-6 animate-fade-in">
          <div className="flex flex-col sm:flex-row gap-5">
            {/* Avatar */}
            <div className={`flex h-20 w-20 sm:h-24 sm:w-24 shrink-0 items-center justify-center rounded-2xl border-4 border-white shadow-lg ${
              business.is_featured ? 'bg-primary-600' : 'bg-slate-700'
            }`}>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            {/* About */}
            <section className="rounded-2xl bg-white border border-slate-200 p-6 animate-fade-in">
            ...
            {activePromotions.length > 0 && (
              <section className="rounded-2xl bg-gradient-to-br from-accent-50 to-accent-100/50 border border-accent-200 p-6 animate-fade-in">
                ...
                <div className="space-y-3">
                  {activePromotions.map((promo) => (
                    <div key={promo.id} className="rounded-xl bg-white p-4 border border-accent-200">
                  ...
                  {business.products.map((product) => (
                    <div
                      ...
                      className={`rounded-xl border p-4 ${
                        product.is_featured ? 'border-warm-200 bg-warm-50/50' : 'border-slate-100'
                      }`}
                    >
                  ...
                  {business.services.map((service) => (
                    <div
                      ...
                      className={`flex items-center justify-between rounded-xl border p-4 ${
                        service.is_featured ? 'border-primary-200 bg-primary-50/50' : 'border-slate-100'
                      }`}
                    >
                      <div>
                        <h3 className="text-sm font-bold text-slate-900">
                      ...
                      <div className="shrink-0 ml-4 text-right">
                        ...
                        {business.whatsapp && (
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="block mt-1 text-xs font-semibold text-accent-600 hover:text-accent-700"
                          >
                            Agendar
                          </a>
                        )}
          ...
          <div className="space-y-6">
            {/* Contact Info */}
            <div className="rounded-2xl bg-white border border-slate-200 p-6 animate-fade-in">
                  ...
                  return (
                    <div
                      ...
                      className={`flex items-center justify-between py-1.5 text-sm ${
                        isToday ? 'font-semibold text-primary-700' : 'text-slate-600'
                      }`}
                    >
