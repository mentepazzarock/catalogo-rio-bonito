  ...
  return (
    <div className="min-h-screen bg-slate-50/50">
      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 -mt-12 relative z-10 pb-16">
            ...
            ([key, plan]) => {
              ...
              return (
                ...
                >
                  ...
                  <button
                    className={`w-full rounded-xl ${colors.btn} px-4 py-3 text-sm font-bold text-white transition-colors shadow-sm`}
                  >
        ...
        {/* CTA */}
        <div className="mt-12 rounded-2xl bg-white border border-slate-200 p-8 sm:p-12 text-center animate-fade-in">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 rounded-xl bg-accent-500 px-8 py-4 text-base font-bold text-white hover:bg-accent-600 transition-colors shadow-lg shadow-accent-500/25"
          >
        ...
        <div className="mt-12">
          ...
          <div className="grid md:grid-cols-2 gap-5">
            {[
              ...
              <div key={faq.q} className="rounded-2xl bg-white border border-slate-200 p-6">
